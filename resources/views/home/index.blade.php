        	...
        	<div class="col-md-3 col-sm-6 col-xs-12 col-custom">
    	      <div class="info-box info-box-new-style">
    	        ...
    	        <div class="info-box-content">
    	          ...
    	          <span class="info-box-number text-white total_purchase"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
    	        </div>
    	        {{-- /.info-box-content --}}
    	      </div>
    	      {{-- /.info-box --}}
    	    ...
    	    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
    	      <div class="info-box info-box-new-style">
    	        ...
    	        <div class="info-box-content">
    	          ...
    	          <span class="info-box-number text-white total_sell"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
    	        </div>
    	        {{-- /.info-box-content --}}
    	      </div>
    	      {{-- /.info-box --}}
    	    ...
    	    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
    	      <div class="info-box info-box-new-style">
    	        ...
    	        <div class="info-box-content">
    	          ...
    	          <span class="info-box-number text-white purchase_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
    	        </div>
    	        {{-- /.info-box-content --}}
    	      </div>
    	      {{-- /.info-box --}}
    	    ...
    	    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
    	      <div class="info-box info-box-new-style">
    	        ...
    	        <div class="info-box-content">
    	          ...
    	          <span class="info-box-number text-white invoice_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
    	        </div>
    	        {{-- /.info-box-content --}}
    	      </div>
    	      {{-- /.info-box --}}
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
              <div class="info-box info-box-new-style">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number text-white total_expense"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                </div>
                {{-- /.info-box-content --}}
              </div>
              {{-- /.info-box --}}
